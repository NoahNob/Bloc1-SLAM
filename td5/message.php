...
<body>
    ...
    <ul>
        <li><a href="?message=Texte en vert, taille 30&size=30&color=green">Vert</a></li>
        <li><a href="?message=Texte en gris, taille 20&size=20&color=grey">Gris</a></li>
        <li><a href="?message=Texte en bleu, Taille 40 40&size=40&color=blue">Bleu</a></li>
    </ul>
